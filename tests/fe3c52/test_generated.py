...
class TestOtherModule:
    ...
    def test_index_html_contains_title_element(self):
        ...
        title_matches = re.search(title_pattern, content, re.IGNORECASE | re.DOTALL)
        assert title_matches is not None, "HTML文件中未找到title标签"
    ...
    def test_index_html_title_content_not_empty(self):
        ...
        assert title_content != "AAA" or len(title_content) >= 3, "title内容可能不完整"
    ...
    def test_dev_notes_contains_content(self):
        ...
        assert has_markdown_elements, "开发文档似乎不包含有效的markdown内容"